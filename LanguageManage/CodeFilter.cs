...
{
    public partial class CodeFilter : Form
    {
        public CodeFilter()
        {
            InitializeComponent();
        ...
        int projectId = -1;
        public CodeFilter(int projectId)
        {
            InitializeComponent();
        ...
        {
            int positionID = Convert.ToInt32(dbOperat.getPositionID(position,projectID));
            if (positionID == 0)
            {
                dbOperat.insertPosition(position, projectID, "Admin");
                positionID = Convert.ToInt32(dbOperat.getPositionID(position, projectID));
            }
            return positionID;
        }
